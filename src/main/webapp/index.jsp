			...
			<div class="wrapper_with_padding">
				<h1>Index page</h1>
					<div class="content">
						...
						<input type="submit" name="submit" ng-click="loadFromSolr()"><br></form>
						</nav>
						<div id="results">
						<section>
						...
						<aside>
							<div ng-repeat="video in videos"> <div class="videoWrapper">
								<div class="video"><a href="api/play/video/{{video.id}}" target="_blank">
								<span ng-bind="video.name"></span></a>
								</div>
								</div>
